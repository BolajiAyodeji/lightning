defmodule LightningWeb.AuditLiveTest do
  ...
  describe ".diff/1" do
    test "correctly lists changes if there are both before and after" do
      assigns = %{
        metadata: %{
          before: %{
            "foo" => "foo_before",
    ...
    test "correctly lists changes if there are no before settings" do
      assigns = %{
        metadata: %{
          before: nil,
    ...
    test "list changes in sequence if the keys are strings" do
      assigns = %{
        metadata: %{
          before: %{"foo" => "foo_before", "bar" => "bar_before", "baz" => "baz_before"},
          after: %{"foo" => "foo_after", "bar" => "bar_after", "baz" => "baz_after"}
